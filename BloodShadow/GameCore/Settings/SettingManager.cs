namespace BloodShadow.GameCore.Settings
{
    ...
    public class SettingManager<TScreen>
    {
        ...
        public Subject<Unit> SaveSubj { get; private set; } = new Subject<Unit>();
        ...
        public SettingManager(string saveDataPath, string systemDataPath, string settingFile, SaveSystem saveSystem)
        {
            ...
            _settingDatas = new Dictionary<Type, SettingData<TScreen>>();
        ...
        public void Load()
        {
            _saveSystem.Load<Dictionary<Type, SettingData<TScreen>>>(SavePath, (data) =>
            {
                ...
                else { _settingDatas = new Dictionary<Type, SettingData<TScreen>>(); }
            });
