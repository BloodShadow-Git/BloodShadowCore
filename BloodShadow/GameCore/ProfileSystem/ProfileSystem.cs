namespace BloodShadow.GameCore.ProfileSystem
{
    ...
    public class ProfileSystem
    {
        ...
        public ProfileSystem(string profilesDir, string tempProfilesDir, SaveSystem saveSystem)
        {
            ...
            _active = new ReactiveProperty<Profile>();
            _profiles = new ObservableList<Profile>();
            ...
            _profileWatcher = new FileSystemWatcher(ProfilesPath) { IncludeSubdirectories = false };
            ...
            _tempWatcher = new FileSystemWatcher(TempProfilesPath) { IncludeSubdirectories = false };
        ...
        {
            profile = new Profile(name, icon, this);
        ...
        {
            profile = new Profile(name, icon, this, dict);
            if (!ValidProfile(profile)) { return false; }
            SaveProfile(profile);
            return true;
        }
