namespace BloodShadow.Core.Operations
{
    ...
    public class OperationCollection : Operation
    {
        ...
        public OperationCollection Merge(OperationCollection operation) { return new([.. _operations, .. operation._operations]); }
        public OperationCollection Merge(IEnumerable<OperationCollection> operations)
        {
            OperationCollection result = new() { _operations = _operations };
        ...
        public override void Wait() { Task.WaitAll([.. _operations.ConvertAll<Task>(input => input)]); }
    }
